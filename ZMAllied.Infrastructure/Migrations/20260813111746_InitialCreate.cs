        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyRates_Companies_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Capacity = table.Column<decimal>(type: "decimal(18,3)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoadingPoint = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    OffloadingPoint = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VehicleMaintenances_Suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OfficeId = table.Column<int>(type: "int", nullable: false),
                    BiltyNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    BiltyDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bilties", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Bilties_Drivers_DriverId",
                        column: x => x.DriverId,
                        principalTable: "Drivers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bilties_Offices_OfficeId",
                        column: x => x.OfficeId,
                        principalTable: "Offices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bilties_Parties_BrokerId",
                        column: x => x.BrokerId,
                        principalTable: "Parties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bilties_Parties_ConsigneeId",
                        column: x => x.ConsigneeId,
                        principalTable: "Parties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bilties_Parties_ConsignorId",
                        column: x => x.ConsignorId,
                        principalTable: "Parties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bilties_Trips_TripId",
                        column: x => x.TripId,
                        principalTable: "Trips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bilties_Vehicles_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FuelExpenses_Suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FuelExpenses_Trips_TripId",
                        column: x => x.TripId,
                        principalTable: "Trips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CompanyId = table.Column<int>(type: "int", nullable: false),
                    BiltyId = table.Column<int>(type: "int", nullable: true),
                    VehicleId = table.Column<int>(type: "int", nullable: false),
                    Weight = table.Column<decimal>(type: "decimal(18,3)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DDRs_Bilties_BiltyId",
                        column: x => x.BiltyId,
                        principalTable: "Bilties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DDRs_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DDRs_Parties_BrokerId",
                        column: x => x.BrokerId,
                        principalTable: "Parties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DDRs_Vehicles_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bilties_BiltyDate",
                table: "Bilties",
                column: "BiltyDate");

            migrationBuilder.CreateIndex(
                name: "IX_Bilties_BiltyNumber",
                table: "Bilties",
                column: "BiltyNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Bilties_BrokerId",
                table: "Bilties",
                column: "BrokerId");

            migrationBuilder.CreateIndex(
                name: "IX_Bilties_ConsigneeId",
                table: "Bilties",
                column: "ConsigneeId");

            migrationBuilder.CreateIndex(
                name: "IX_Bilties_ConsignorId",
                table: "Bilties",
                column: "ConsignorId");

            migrationBuilder.CreateIndex(
                name: "IX_Bilties_DriverId",
                table: "Bilties",
                column: "DriverId");

            migrationBuilder.CreateIndex(
                name: "IX_Bilties_OfficeId",
                table: "Bilties",
                column: "OfficeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DDRs_BiltyId",
                table: "DDRs",
                column: "BiltyId");

            migrationBuilder.CreateIndex(
                name: "IX_DDRs_BrokerId",
                table: "DDRs",
                column: "BrokerId");

            migrationBuilder.CreateIndex(
                name: "IX_DDRs_CompanyId",
                table: "DDRs",
                column: "CompanyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DDRs_VehicleId",
                table: "DDRs",
                column: "VehicleId");

            migrationBuilder.CreateIndex(
                name: "IX_Drivers_CNIC",
                table: "Drivers",
                column: "CNIC");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FuelExpenses_SupplierId",
                table: "FuelExpenses",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_FuelExpenses_TripId",
                table: "FuelExpenses",
                column: "TripId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleMaintenances_SupplierId",
